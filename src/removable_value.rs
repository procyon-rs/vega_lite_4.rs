...
from_into_with_removable! {
    ...
    &str => Color,
    &str => ColorUnion,
    &str => ConditionalValueDefGradientStringNullPredicateComposition,
    &str => ConditionalValueDefGradientStringNullSelectionComposition,
    ...
    &str => SelectionInit,
    &str => SelectionInitIntervalElement,
    &str => Text,
    &str => Translate,

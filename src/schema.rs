...
pub struct Vegalite {
    ...
    pub autosize: Option<AutosizeType>,
...
pub struct RowColumnEncodingFieldDef {
    ...
    /// __See also:__ [`type`](https://vega.github.io/vega-lite/docs/type.html) documentation.
    #[serde(rename = "type")]
    pub row_column_encoding_field_def_type: StandardType,
}
...
pub struct TypedFieldDef {
    ...
    /// __See also:__ [`type`](https://vega.github.io/vega-lite/docs/type.html) documentation.
    #[serde(rename = "type")]
    pub typed_field_def_type: StandardType,
}
...
pub struct OrderFieldDef {
    ...
    /// __See also:__ [`type`](https://vega.github.io/vega-lite/docs/type.html) documentation.
    #[serde(rename = "type")]
    pub order_field_def_type: StandardType,
}
...
pub struct ConditionalValueDefText {
    ...
    /// definition](https://vega.github.io/vega-lite/docs/types.html#gradient) for color, values
    /// between `0` to `1` for opacity).
    pub value: ConditionalValueDefTextText,
    /// A [selection name](https://vega.github.io/vega-lite/docs/selection.html), or a series of
    /// [composed selections](https://vega.github.io/vega-lite/docs/selection.html#compose).
    pub selection: Box<Option<Box<PurpleSelectionOperand>>>,
}
...
pub struct StringFieldDef {
    ...
    /// __See also:__ [`type`](https://vega.github.io/vega-lite/docs/type.html) documentation.
    #[serde(rename = "type")]
    pub string_field_def_type: StandardType,
}
...
pub struct TitleParams {
    ...
    /// The title text.
    pub text: ConditionalValueDefTextText,
...
pub struct JoinAggregateFieldDef {
    ...
    #[serde(rename = "as")]
    pub join_aggregate_field_def_as: String,
